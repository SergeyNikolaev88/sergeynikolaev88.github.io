...
BLOG_AUTHOR = "Sergey Nikolaev"  # (translatable)
BLOG_TITLE = "Programmer's Diary"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://sergeynikolaev88.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://sergeynikolaev88.github.io/"
BLOG_EMAIL = "me@nikser.ru"
BLOG_DESCRIPTION = "A hardcore way to achieve goals"  # (translatable)
